...
var file_protos_api_api_proto_rawDesc = []byte{
	...
	0x6b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xeb, 0x04, 0x0a, 0x03, 0x41, 0x50, 0x49, 0x12,
	...
	0x74, 0x65, 0x3a, 0x01, 0x2a, 0x42, 0x32, 0x5a, 0x30, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_protos_api_api_proto_goTypes = []interface{}{
	...
	(*user.UserResponse)(nil),            // 6: demo_user.UserResponse
	(*project.ProjectResponse)(nil),      // 7: demo_project.ProjectResponse
	(*task.TaskResponse)(nil),            // 8: demo_task.TaskResponse
}
var file_protos_api_api_proto_depIdxs = []int32{
	...
	6, // 6: demo_api.API.RegisterUser:output_type -> demo_user.UserResponse
	6, // 7: demo_api.API.LoginUser:output_type -> demo_user.UserResponse
	7, // 8: demo_api.API.CreateProject:output_type -> demo_project.ProjectResponse
	7, // 9: demo_api.API.GetProject:output_type -> demo_project.ProjectResponse
	8, // 10: demo_api.API.CreateTask:output_type -> demo_task.TaskResponse
	8, // 11: demo_api.API.UpdateTask:output_type -> demo_task.TaskResponse
